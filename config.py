...
B_RULE_CONFIG = {
    "default_rules": [
        ...
        },
        {
            ...
            "conclusion": "该要求需政府官方网站备案/可查询验证。【真实持证豁免】若所需证书公司A类库中确实真实持有、且属'证书本身即为评分项所要求那一类'的严格匹配(如要求质量/环境/职业健康安全管理体系认证，A类库正好持有对应证书)，则核验可正常通过，判定为满足、不触发本排除规则(此类通用体系认证ISO9001/14001/45001本就登记于cnca.cn，真实持证即为有效)。【仍触发排除的情形】所需材料公司并不真实持有，或仅靠'语义相似/通用分类/可视为子类'把通用体系认证硬套为其不能覆盖的具体产品认证/能效认证/专业业务范围认证——此类需提供真实的政府官方网站备案材料，判0分",
            "rule_type": "排除类",
            "is_active": 1
        },
        {
